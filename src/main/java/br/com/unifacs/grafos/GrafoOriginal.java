...
// public GrafoOriginal(int tipo, int qtdVertices) {
...
// if (tipoGrafo == 2) {
// System.out.println("\t\tAresta com peso = " + peso + " inserida entre os
// vértices " + v1 + " e " + v2 + "!");
// } else {
// System.out.println("\t\tAresta com valor = " + peso + " inserida entre os
// vértices " + v1 + " e " + v2 + "!");
// }
// }
// }
